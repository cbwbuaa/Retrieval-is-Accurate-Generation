...
class CopyisallyouneedPrefixOnly(Dataset):
    ...
    def __getitem__(self, i):
        ...
        return all_gpt_ids, all_gpt2_mask, all_false_neg_mask, all_phrase_label, embeddings
    ...
    def collate(self, batch):
        assert len(batch) == 1
        all_gpt_ids, all_gpt2_mask, all_false_neg_mask, all_phrase_label, embeddings = batch[0]
        return {
