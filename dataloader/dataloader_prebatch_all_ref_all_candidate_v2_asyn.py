...
class CopyisallyouneedWikitext103V2DatasetPrebatchAllRefAllCandidateV2Asyn(Dataset):
    ...
    def __init__(self, **args):
        ...
        self.file_lists = [f'{args["training_data_dir"]}/train/train_{args["local_rank"]}.jsonl']
