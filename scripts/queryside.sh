...
# version=prebatch_neg0_pretrain40w_100w
# version=prebatch4096_neg1_pretrain40w
version=test
...
trained_model_path=/apdcephfs/share_916081/shared_info/ponybwcao/Copyisallyouneed/ckpt/wikitext103/copyisallyouneed/train/best_prebatch_neg0_pretrain40w_1000000.pt
training_data_dir=/apdcephfs/share_916081/shared_info/ponybwcao/data/8split_0neg

gpu_ids=(${cuda//,/ })
CUDA_VISIBLE_DEVICES=$cuda python3 -m torch.distributed.launch --nproc_per_node=${#gpu_ids[@]} --master_addr 127.0.0.1 --master_port 28446 queryside.py \
    --dataset $dataset \
    --model $model \
    --multi_gpu $cuda \
